...
- LLM: OpenRouter at base url `https://openrouter.ai/api/v1`, OpenAI-compatible chat/completions shape (NOT the Anthropic Messages shape). Model slug `google/gemma-4-31b-it:free` (free slugs rotate; verify at impl time).
